        ...
        <section className='about' id='about'>
            ...
            <div className="about__info">
                <div className="about__info__description">
                    <p>
                        <span>I’m a front-end developer who’s all about building clean, modern, and user-friendly interfaces. I love turning designs into real, responsive web apps using tools like React, TypeScript, and SASS — always keeping things smooth, fast, and accessible.</span>
